  ...
  <div>
    <router-link to="/profile">
      <!-- <div v-if="profile != null" class="flex cursor-pointer">
        <img :src="'https://api-moshop.molengeek.pro' + profile.picture_path" class="h-6 rounded-l-full" alt />
        <div>
          <span class="profile"> Bonjour {{ profile.firstname + ' ' + profile.lastname }} !</span>
        </div>
      </div> -->
      <div v-if="profile != null" class="flex cursor-pointer app">
        <header class="app-header">
          ...
          <div class="app-header-actions">
            <button class="user-profile">
              ...
              <span>
                <img :src="'https://api-moshop.molengeek.pro' + profile.picture_path" />
              </span>
            </button>
          </div>
          ...
          <div class="app-body-navigation">
            <nav class="navigation">
              ...
              <a href="#">
                ...
                <span>Commandes open</span>
              </a>
              <a href="#">
                <i class="ph-swap"></i>
                <span>Commandes done</span>
              </a>
              <a href="#">
              ...
              <div class="service-section-header">
                <form @submit.prevent="PostUpdate" >
                  <div class="search-field">
                    ...
                    <input type="text" class="form-control" placeholder="Modifier votre prénom">
                    <span>Last Name</span>
                    <input type="text" placeholder="Modifier votre nom">
                    <input type="file" class="hidden" accept=".jpeg, .jpg, .png" @change="handleInputFile" />
                  </div>
...
<script>
  ...
  export default {
    ...
    created() {
      axios.get(`https://api-moshop.molengeek.pro/api/v1/user/${this.$route.params.id}`)
      .then((response) => {
    ...
    methods: {
      ...
      PostUpdate() {
          axios.put(`https://api-moshop.molengeek.pro/api/v1/user/${this.$route.params.id}`, this.profile)
              .then((response) => {
                  this.$router.push({
                      name: 'firstname',
                      // name: 'lastname'
