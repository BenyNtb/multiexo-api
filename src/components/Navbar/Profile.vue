<template>
  <div>
    ...
    <div class="search-field">
      ...
      <input type="text" class="form-control" placeholder="Modifier votre prénom" v-model="firstname"> 
      <span>Last Name</span>
      <input type="text" placeholder="Modifier votre nom" v-model="lastname">
